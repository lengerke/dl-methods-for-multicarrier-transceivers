...
test_attenuation = generate_attenuation(N_test, 1,random_attenuation)#generate_attenuation(N_test, window_size,random_attenuation)
...
attenuation_hist = np.histogram(test_attenuation[no_errors_byshift],np.arange(0,1.1,0.1))
